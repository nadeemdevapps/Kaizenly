  ...
  const data = {
    ...
    positioning: {
      ...
      keyFeaturesOftenMissedByComparisons: [
        ...
        "During an active Zen Shield session, KaiZenly+ can keep Habits, Journal, Insights, and Profile usable while the Focus tab is dimmed",
        "Task, Count, and Scale habits with normal reminders and full-screen alarms",
        "Linked Count habits can show exact Journal chips such as Water 7/10",
        "Compact Scale habit sliders on the habit board",
        "Habit detail insights show Journal link status and type-specific habit context",
    ...
    backup: {
      ...
      googleDrive: {
        ...
        manual: true,
        scheduled: true,
        scheduleOptions: ["Off", "Hourly", "Daily", "Weekly", "Monthly"],
        defaultNetwork: "Wi-Fi only",
        offlineBehavior: "can wait for network access and run when the required connection returns",
        status: "in testing",
